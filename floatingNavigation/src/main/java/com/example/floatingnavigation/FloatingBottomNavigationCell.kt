...
import com.example.floatingnavigation.databinding.FloatingNavigationCellBinding


@Suppress("unused")
class FloatingBottomNavigationCell @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = DataBindingUtil.inflate<FloatingNavigationCellBinding>(
        LayoutInflater.from(context),
        R.layout.floating_navigation_cell,
        this,
        true
    )
