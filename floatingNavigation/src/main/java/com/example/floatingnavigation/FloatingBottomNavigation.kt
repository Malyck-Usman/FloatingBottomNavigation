package com.example.floatingnavigation
...
internal typealias IBottomNavigationListener = (model: FloatingBottomNavigation.Model) -> Unit
@Suppress("MemberVisibilityCanBePrivate")
class FloatingBottomNavigation : FrameLayout {

    var models = ArrayList<Model>()
    var cells = ArrayList<FloatingBottomNavigationCell>()
        private set
    ...
    private fun initializeViews() {
        ...
        bezierView.apply {
            ...
            shadowColor = this@FloatingBottomNavigation.shadowColor
        }
    ...
    fun add(model: Model) {
        val cell = FloatingBottomNavigationCell(context)
        cell.apply {
            val params = LinearLayout.LayoutParams(0, heightCell, 1f)
            layoutParams = params
            icon = model.icon
            count = model.count
            defaultIconColor = this@FloatingBottomNavigation.defaultIconColor
            selectedIconColor = this@FloatingBottomNavigation.selectedIconColor
            circleColor = this@FloatingBottomNavigation.circleColor
            countTextColor = this@FloatingBottomNavigation.countTextColor
            countBackgroundColor = this@FloatingBottomNavigation.countBackgroundColor
            countTypeface = this@FloatingBottomNavigation.countTypeface
            rippleColor = this@FloatingBottomNavigation.rippleColor
            onClickListener = {
    ...
    private fun anim(cell: FloatingBottomNavigationCell, id: Int, enableAnimation: Boolean = true) {
        isAnimating = true
    ...
    fun getCellById(id: Int): FloatingBottomNavigationCell? {
    ...
    fun clearCount(id: Int) {
        val model = getModelById(id) ?: return
        val pos = getModelPosition(id)
        model.count = FloatingBottomNavigationCell.EMPTY_VALUE
        cells[pos].count = FloatingBottomNavigationCell.EMPTY_VALUE
    }
    ...
    class Model(var id: Int, var icon: Int) {
        ...
        var count: String = FloatingBottomNavigationCell.EMPTY_VALUE
